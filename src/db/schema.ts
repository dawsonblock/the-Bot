import { pgTable, text, timestamp, uuid, jsonb, index, bigint, integer } from "drizzle-orm/pg-core";
...
export const traces = pgTable("traces", {
  ...
  index("idx_traces_created_at").on(table.createdAt)
]);
...
export const events = pgTable("events", {
  ...
  index("idx_events_trace_sequence").on(table.traceId, table.sequence)
]);
